...
class OrderSSlip extends Controller
{
    public function renderOrderPrintSlip()
    {
        ...
        if (Filesystem::exists(DIR_BASE."/application/elements/order_slip.php")) {
            ...
            View::element("order_sslip", array('order' => $o, 'orderChoicesEnabled' => $orderChoicesEnabled, 'orderChoicesAttList' => $orderChoicesAttList), "community_store");
        }
    }
}
