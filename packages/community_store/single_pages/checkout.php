                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="store-checkout-billing-zip"><?= t("Zip Code") ?></label>
                                    <?= $form->text('store-checkout-billing-zip', $customer->getAddressValue('billing_address', 'postal_code'), array('placeholder'=>t('Zip Code'))); ?>
                                </div>
                                <div class="form-group">
                                    <label for="store-checkout-billing-country"><?= t("Country") ?></label>
                                    <?php $country = $customer->getAddressValue('billing_address', 'country') ?>
                                    <?= $form->select('store-checkout-billing-country', $billingCountries, $country ? $country : ($defaultBillingCountry ? $defaultBillingCountry : 'AE'), array("onchange" => "communityStore.updateBillingStates()")); ?>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="store-checkout-shipping-zip"><?= t("PO Box") ?></label>
                                            <?= $form->text('store-checkout-shipping-zip', $customer->getAddressValue('shipping_address', 'postal_code'), array('placeholder'=>t('PO Box'))); ?>
                                    </div>
                                    <div class="form-group">
                                        <label for="store-checkout-shipping-country"><?= t("Country") ?></label>
                                        <?php $country = $customer->getAddressValue('shipping_address', 'country'); ?>
                                        <?= $form->select('store-checkout-shipping-country', $shippingCountries, $country ? $country : ($defaultShippingCountry ? $defaultShippingCountry : 'AE'), array("onchange" => "communityStore.updateShippingStates()")); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="store-checkout-form-group-buttons">
