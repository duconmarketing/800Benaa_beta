...
//            var pane = $(obj).closest(".store-checkout-form-group").find('.store-checkout-form-group-body').parent().next();
            var pane = $(obj).closest(".store-checkout-form-group").find('.store-checkout-form-group-body').parent().nextAll(':not(#store-checkout-form-group-shipping-method)').first();
            $('.store-active-form-group').removeClass('store-active-form-group');
            pane.addClass('store-active-form-group');
...
$(document).ready(function () {
            ...
            success: function (result) {
                ...
                if (response.error == false) {
                    ...
                    if ($('#store-copy-billing').is(":checked")) {
                        ...
                        $("#store-checkout-form-group-shipping-method").submit(); // Added to skip the second last step as it's found useless by Maged.
                        $('#store-checkout-form-group-shipping-method').hide();
    ...
    $(".store-btn-previous-pane").click(function (e) {
        ...
        var pane = $(this).closest(".store-checkout-form-group").find('.store-checkout-form-group-body').parent().prevAll(':not(#store-checkout-form-group-shipping-method)').first();
        $('.store-active-form-group').removeClass('store-active-form-group');
        pane.addClass('store-active-form-group');
        ...
        $(this).closest(".store-checkout-form-group").prevAll(':not(#store-checkout-form-group-shipping-method)').first().removeClass("store-checkout-form-group-complete");
//        $('#store-checkout-form-group-shipping-method').hide();
        e.preventDefault();
    });
