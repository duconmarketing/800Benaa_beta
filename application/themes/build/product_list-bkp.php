...
$.ajax({
   ...
   data: { 'filterOptioncategory' : filterOptions['category'],'filterOptionbrand': filterOptions['brand'],'currentSection':'<?php echo $c->getCollectionID(); ?>'<?php if($c->getAttribute('show_best_seller')){ ?>,'showBestSeller':'true'<?php } ?>},
   error: function() {
