...
<?php } ?>
    ...
    <form accept-charset="UTF-8" method="post" action="https://www2.duconodl.com/l/631421/2020-07-20/2zh33" class="form" id="pardot-form" style="display:none;">
        <p class="form-field  first_name pd-text required    ">
            <label class="field-label" for="631421_81284pi_631421_81284">First Name</label>
            <input type="text" name="631421_81284pi_631421_81284" id="631421_81284pi_631421_81284" value="" class="text" size="30" maxlength="40" onchange="" onfocus="" />
        </p>
        <div id="error_for_631421_81284pi_631421_81284" style="display:none"></div>
        <p class="form-field  last_name pd-text required    ">
            <label class="field-label" for="631421_81286pi_631421_81286">Last Name</label>
            <input type="text" name="631421_81286pi_631421_81286" id="631421_81286pi_631421_81286" value="" class="text" size="30" maxlength="80" onchange="" onfocus="" />
        </p>
        <div id="error_for_631421_81286pi_631421_81286" style="display:none"></div>
        <p class="form-field  company pd-text">
            <label class="field-label" for="631421_81288pi_631421_81288">Company</label>
            <input type="text" name="631421_81288pi_631421_81288" id="631421_81288pi_631421_81288" value="" class="text" size="30" maxlength="255" onchange="" onfocus="" />
        </p>
        <div id="error_for_631421_81288pi_631421_81288" style="display:none"></div>
        <p class="form-field  email pd-text required">
            <label class="field-label" for="631421_81290pi_631421_81290">Email</label>
            <input type="text" name="631421_81290pi_631421_81290" id="631421_81290pi_631421_81290" value="" class="text" size="30" maxlength="255" />
        </p>
        <div id="error_for_631421_81290pi_631421_81290" style="display:none"></div>
        <p class="form-field  phone pd-text required    ">
            <label class="field-label" for="631421_81292pi_631421_81292">Contact Number</label>
            <input type="text" name="631421_81292pi_631421_81292" id="631421_81292pi_631421_81292" value="" class="text" size="30" maxlength="40" onchange="" onfocus="" />
        </p>
        <div id="error_for_631421_81292pi_631421_81292" style="display:none"></div>
        <p class="form-field  address_one pd-textarea required    ">
            <label class="field-label" for="631421_81294pi_631421_81294">Address Line</label>
            <textarea name="631421_81294pi_631421_81294" id="631421_81294pi_631421_81294" onchange="" cols="40" rows="10" class="standard"></textarea>
        </p>
        <div id="error_for_631421_81294pi_631421_81294" style="display:none"></div>
        <p class="form-field  zip pd-text     ">
            <label class="field-label" for="631421_81296pi_631421_81296">PO Box</label>
            <input type="text" name="631421_81296pi_631421_81296" id="631421_81296pi_631421_81296" value="" class="text" size="30" maxlength="32" onchange="" onfocus="" />
        </p>
        <div id="error_for_631421_81296pi_631421_81296" style="display:none"></div>
        <p class="form-field  city pd-text required    ">
           <label class="field-label" for="631421_79379pi_631421_79379">Town/City</label>
           <input type="text" name="631421_79379pi_631421_79379" id="631421_79379pi_631421_79379" value="City" class="text" size="30" maxlength="40" onchange="" onfocus="" />
        </p>
        <div id="error_for_631421_79379pi_631421_79379" style="display:none"></div>
        <p class="form-field  state pd-text required    ">
            <label class="field-label" for="631421_81300pi_631421_81300">Region</label>
            <input type="text" name="631421_81300pi_631421_81300" id="631421_81300pi_631421_81300" value="" class="text" size="30" maxlength="80" onchange="" onfocus="" />
        </p>
        <div id="error_for_631421_81300pi_631421_81300" style="display:none"></div>
        <p class="form-field  country pd-text required    ">
            <label class="field-label" for="631421_81302pi_631421_81302">Country</label>
            <input type="text" name="631421_81302pi_631421_81302" id="631421_81302pi_631421_81302" value="" class="text" size="30" maxlength="80" onchange="" onfocus="" />
        </p>
        <div id="error_for_631421_81302pi_631421_81302" style="display:none"></div>
    ...
    $("#store-checkout-form-group-billing").submit(function(){
        $("#631421_81284pi_631421_81284").val($("#store-checkout-billing-first-name").val());
        $("#631421_81286pi_631421_81286").val($("#store-checkout-billing-last-name").val());
//        $("#631421_81288pi_631421_81288").val($("#akID[45][value]").val());
        $("#631421_81290pi_631421_81290").val($("#store-email").val());
        $("#631421_81292pi_631421_81292").val($("#store-checkout-billing-phone").val());
        $("#631421_81294pi_631421_81294").val($("#store-checkout-billing-address-1").val());
        $("#631421_81296pi_631421_81296").val($("#store-checkout-billing-zip").val());
//        $("#631421_79379pi_631421_79379").val('city');
//        $("#631421_79379pi_631421_79379").val($("#store-checkout-billing-city").val());
        $("#631421_81300pi_631421_81300").val($("#store-checkout-billing-state option:selected").text());
        $("#631421_81302pi_631421_81302").val($("#store-checkout-billing-country").val());
        $("#631421_81288pi_631421_81288").val('Online Order');
    });   
