...
<!--                                <input type="checkbox" id="terms" name="terms" value="terms" required>
                                    <label for="terms"> I agree to the <a data-toggle="modal" data-target="#termsModal">Terms and Conditions</a></label><br>-->
                                
                                 <a href="#" class="store-btn-previous-pane btn btn-default"><?= t("Edit") ?></a>
                                <input type="submit" class="store-btn-complete-order btn btn-default pull-right" value="<?= $pm->getButtonLabel()? $pm->getButtonLabel() : t("Complete dOrder") ?>">
...
<?php } ?>
    ...
    <form accept-charset="UTF-8" method="post" action="https://www2.duconodl.com/l/631421/2020-06-27/2x7x6" class="form" id="pardot-form" style="display:none;">
        <p class="form-field  first_name pd-text required    ">
            <label class="field-label" for="631421_79365pi_631421_79365">First Name</label>
            <input type="text" name="631421_79365pi_631421_79365" id="631421_79365pi_631421_79365" value="" class="text" size="30" maxlength="40" onchange="" onfocus="" />
        </p>
        <div id="error_for_631421_79365pi_631421_79365" style="display:none"></div>
        <p class="form-field  last_name pd-text required    ">
            <label class="field-label" for="631421_79367pi_631421_79367">Last Name</label>
            <input type="text" name="631421_79367pi_631421_79367" id="631421_79367pi_631421_79367" value="" class="text" size="30" maxlength="80" onchange="" onfocus="" />
        </p>
        <div id="error_for_631421_79367pi_631421_79367" style="display:none"></div>
        <p class="form-field  company pd-text     ">
            <label class="field-label" for="631421_79369pi_631421_79369">Company</label>
            <input type="text" name="631421_79369pi_631421_79369" id="631421_79369pi_631421_79369" value="" class="text" size="30" maxlength="255" onchange="" onfocus="" />
        </p>
        <div id="error_for_631421_79369pi_631421_79369" style="display:none"></div>
        <p class="form-field  email pd-text required    ">
            <label class="field-label" for="631421_79371pi_631421_79371">Email</label>
            <input type="text" name="631421_79371pi_631421_79371" id="631421_79371pi_631421_79371" value="" class="text" size="30" maxlength="255" />
        </p>
        <div id="error_for_631421_79371pi_631421_79371" style="display:none"></div>
        <p class="form-field  phone pd-text required    ">
            <label class="field-label" for="631421_79373pi_631421_79373">Contact Number</label>
            <input type="text" name="631421_79373pi_631421_79373" id="631421_79373pi_631421_79373" value="" class="text" size="30" maxlength="40" onchange="" onfocus="" />
        </p>
        <div id="error_for_631421_79373pi_631421_79373" style="display:none"></div>
        <p class="form-field  address_one pd-textarea required    ">
            <label class="field-label" for="631421_79375pi_631421_79375">Address Line</label>
            <textarea name="631421_79375pi_631421_79375" id="631421_79375pi_631421_79375" onchange="" cols="40" rows="10" class="standard"></textarea>
        </p>
        <div id="error_for_631421_79375pi_631421_79375" style="display:none"></div>
        <p class="form-field  zip pd-text     ">
            <label class="field-label" for="631421_79377pi_631421_79377">PO Box</label>
            <input type="text" name="631421_79377pi_631421_79377" id="631421_79377pi_631421_79377" value="" class="text" size="30" maxlength="32" onchange="" onfocus="" />
        </p>
        <div id="error_for_631421_79377pi_631421_79377" style="display:none"></div>
        <p class="form-field  city pd-text required    ">
           <label class="field-label" for="631421_79379pi_631421_79379">Town/City</label>
           <input type="text" name="631421_79379pi_631421_79379" id="631421_79379pi_631421_79379" value="" class="text" size="30" maxlength="40" onchange="" onfocus="" />
        </p>
        <div id="error_for_631421_79379pi_631421_79379" style="display:none"></div>
        <p class="form-field  state pd-text required    ">
            <label class="field-label" for="631421_79381pi_631421_79381">Region</label>
            <input type="text" name="631421_79381pi_631421_79381" id="631421_79381pi_631421_79381" value="" class="text" size="30" maxlength="80" onchange="" onfocus="" />
        </p>
        <div id="error_for_631421_79381pi_631421_79381" style="display:none"></div>
        <p class="form-field  country pd-text required    ">
            <label class="field-label" for="631421_79383pi_631421_79383">Country</label>
            <input type="text" name="631421_79383pi_631421_79383" id="631421_79383pi_631421_79383" value="" class="text" size="30" maxlength="80" onchange="" onfocus="" />
        </p>
        <div id="error_for_631421_79383pi_631421_79383" style="display:none"></div>
        ...
        <p class="submit">
            <input type="submit" accesskey="s" value="Checkout" />
        </p>
    ...
    $("#store-checkout-form-group-billing").submit(function(){
        $("#631421_79365pi_631421_79365").val($("#store-checkout-billing-first-name").val());
        $("#631421_79367pi_631421_79367").val($("#store-checkout-billing-last-name").val());
//        $("#631421_79369pi_631421_79369").val($("#akID[45][value]").val());
        $("#631421_79371pi_631421_79371").val($("#store-email").val());
        $("#631421_79373pi_631421_79373").val($("#store-checkout-billing-phone").val());
        $("#631421_79375pi_631421_79375").val($("#store-checkout-billing-address-1").val());
        $("#631421_79377pi_631421_79377").val($("#store-checkout-billing-zip").val());
        $("#631421_79379pi_631421_79379").val('city');
//        $("#631421_79379pi_631421_79379").val($("#store-checkout-billing-city").val());
        $("#631421_79381pi_631421_79381").val($("#store-checkout-billing-state option:selected").text());
        $("#631421_79383pi_631421_79383").val($("#store-checkout-billing-country").val());
        $("#631421_79369pi_631421_79369").val('Online Order');
    });   
    
    $("#store-checkout-form-group-payment").submit(function(){
        $.post($("#pardot-form").attr('action'), $("#pardot-form").serialize(), function(res){
        });
    });
    </script>