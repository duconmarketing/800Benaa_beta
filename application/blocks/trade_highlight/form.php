...
<div class="form-group">
    ...
    <?php  echo Core::make("helper/concrete/asset_library")->image('ccm-b-trade_highlight-image-' . Core::make('helper/validation/identifier')->getString(18), $view->field('image'), t("Choose Image"), $image_o); ?>
</div>
