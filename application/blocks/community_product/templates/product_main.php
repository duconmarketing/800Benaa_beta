                                    ...
                                    <a rel="<?= $secondaryimage->getRelativePath() ?> " href="javascript:void(0)" title="<?= h($product->getName()); ?>" class="">
                                        ...
                                        if ($loop == 1) {
                                            ...
                                            <?php } elseif ($brndName == "NEO") { ?>
                                                <img class="xzoom-gallery" style="position:absolute;top:0px;left:30px;height:30px;" src="<?php echo $this->getThemePath() ?>/images/neo.png" class="img-responsive brand_det">
                                            <?php } elseif ($brndName == "GRAPHITE") { ?>
                                                <img class="xzoom-gallery" style="position:absolute;top:0px;left:30px;height:20px;" src="<?php echo $this->getThemePath() ?>/images/graphite.png" class="img-responsive brand_det">
                                            <?php } elseif ($brndName == "TOPEX NEW") { ?>
                                                <img class="xzoom-gallery" style="position:absolute;top:0px;left:25px;height:33px;" src="<?php echo $this->getThemePath() ?>/images/topex_new.png" class="img-responsive brand_det">
                                            <?php } elseif ($brndName == "VERTO") { ?>
                                                <img class="xzoom-gallery" style="position:absolute;top:0px;left:25px;height:25px;" src="<?php echo $this->getThemePath() ?>/images/verto.png" class="img-responsive brand_det">
                                            <?php } elseif ($brndName == "TAIF LED") { ?>
                                                <img class="xzoom-gallery" style="position:absolute;top:0px;left:30px;height:125px;" src="<?php echo $this->getThemePath() ?>/images/taif_led.png" class="img-responsive brand_det">
                                            <?php } else { ?>
